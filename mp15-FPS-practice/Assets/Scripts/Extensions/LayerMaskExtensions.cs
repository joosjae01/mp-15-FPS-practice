...
public static class LayerMaskExtensions
{
    ...
    {
        return mask.value | go.layer;
    }

    public static LayerMask Add(this LayerMask mask, Component component)
    {
        return mask.value | component.gameObject.layer;
    }
    ...
    public static LayerMask Fill(this LayerMask mask)
    {
        return ~0;
    }

    public static LayerMask Clear(this LayerMask mask)
    {
        return 0;
    }
}
